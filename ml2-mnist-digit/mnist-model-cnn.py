...
def save_model(model):
    ...
    # The key values of the inputs and outputs dictionaries are used
    # as the index keys for the input and output tensors of the model.
...
def run_test_harness():
    ...
    # save model
    model.save('model/model-cnn-mnist.h5')
    # save_model(model)
    # evaluate model
    _, acc = model.evaluate(testX, testY, verbose=0)
    print('> %.3f' % (acc * 100.0))
